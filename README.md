...
- Search anecdote.
- Vote for anecdote
- List anecdotes sorted per number of votes.
...
```
  git clone git@github.com:belmeetmule/anecdotes.git
  cd homely-frontend
```
...
To run the project, first run the server then run the client.
...
Feel free to check the [issues page](https://github.com/belmeetmule/anecdotes/issues).
...
Thank you to  [fullstackopen](https://fullstackopen.com/) for availing such a wonderfull resource for free.
